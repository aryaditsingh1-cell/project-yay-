...
def thank_you_message(items):
    if items >= 5:
        return "NICE NOW GIVE ME A TIP. YOU'RE A GOOD CUSTOMER."
    else:
        return "GO BUY MORE STUFF. YOU NEED IT."
