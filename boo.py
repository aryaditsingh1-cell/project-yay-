...
print(f"this costs {ticket_price} units.")
print("we like these coins: 1, 5, 10, 25\n")
...
while True:
    coin = int(input("put a coin(1, 5, 10, or 25): "))
...
print("printing ticket beep boop beep")
